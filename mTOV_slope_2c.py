...
for i in range(5):
    ...
    np.savetxt('../{}/{}_mTOV_{}_run_{}_2c_slope.txt'.format(folder, detector, mtov_True, str(event_counts[i])), samples)
    np.savetxt('../{}/{}_mTOV_{}_run_{}_2c_slope_likes.txt'.format(folder, detector, mtov_True, str(event_counts[i])), likes)
    if i != 4:
...
print('../{}/{}_mTOV_{}_run_{}_2c_slope.txt'.format(folder, detector, mtov_True, str(event_counts[i])))
