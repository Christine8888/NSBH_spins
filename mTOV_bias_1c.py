...
nsbh_population = p.Population([1.5, 0.5, mtov_True, 1, 3, bh_min, bh_slope], 'nsbh_one', vary_slope=False, selection=True, m1_nospin = True, spinning=True, spin_params=[max_jjkep, spin_slope], ignore_spin=True)
